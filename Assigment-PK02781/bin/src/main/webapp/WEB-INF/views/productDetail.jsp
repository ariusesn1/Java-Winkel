...
<c:set var="sanpham" value="${product}"></c:set>
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            ...
            <h1 class="mb-0 bread">${product.getName() }</h1>
          </div>
        </div>
      </div>
    </div>
    	...
    	<div class="container">
    		<div class="row">
    			<div class="col-lg-6 mb-5 ftco-animate">
    				<a href="images/menu-2.jpg" class="image-popup"><img src="${product.getImage()}" class="img-fluid" alt="Colorlib Template"></a>
    			</div>
